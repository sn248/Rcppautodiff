...
The library also comes with excellent documentation and examples. The original `C++` examples can be seen [here](https://autodiff.github.io/tutorials/)(not all the examples in the original reference have been reproduced here). The examples in the tutorial page of [autodiff](https://autodiff.github.io/) are recreated here with `Rcppautodiff`, interspersed with comments on how to convert from `autodiff` data-types to `Rcpp` or `R` data types and back.
